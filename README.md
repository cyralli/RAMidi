...
2. Install [xxd](https://sourceforge.net/projects/xxd-for-windows/), if you are on Linux or if you ever installed Git, it is not needed.
3. Run the makefile to build the project. Done!
